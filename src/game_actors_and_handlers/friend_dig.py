...
class FriendDigger(BaseActor):
    ...
    def perform_action(self):
        go_to_friend = {"action":"gameState","locationId":"main","user":"3579917","type":"gameState"}#{"id":8,"action":"gameState","objId":null,"locationId":"main","user":"200961723","type":"gameState"}
...
#        dig = {"x":72,"action":"remoteDig","y":92,"id":18,"type":"item","objId":41979} # 116164569
        dig = {"x":116,"action":"remoteDig","y":25,"id":14,"type":"item","objId":37242}
        dig_count = 299
